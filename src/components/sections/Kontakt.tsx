        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <SportButton type="submit" variant="primary" fullWidth>
                Nachricht senden →
              </SportButton>
              ...
              >
                Das Senden öffnet deinen E-Mail-Client mit der vorausgefüllten Nachricht.
              </p>
            </div>
          </form>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
            ...
            <ContactInfo
              icon={<FacebookIcon />}
              label="Facebook"
              value="SV Rot-Weiß Niederklein 1921"
